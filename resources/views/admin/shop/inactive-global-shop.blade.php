...
@section('title','Inactive Global SHops')
@section('css')
    <style>
        .switch {
            position: relative;
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Inactive Global Shop</a></li>
                            ...
                            <div class="table-responsive">
                                <table id="table_id" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        @if (str_contains($customer['customer_id'], 'GS') == true)
                                            <tr>
