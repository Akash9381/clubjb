...
@section('content')
    <section class="content">
        ...
        <form id="user-form" action="{{ url('admin/update-global-shop/' . $shop['id']) }}" method="POST"
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <textarea rows="4" name="address_1" class="form-control no-resize" placeholder="Enter your Address">{{ $shop['address_1'] }}</textarea>
                                    </div>


                                    <div class="col-lg-6 col-md-6">
                                        <p> <b>Address Line 2</b> </p>
                                        <textarea rows="4" name="address_2" class="form-control no-resize" placeholder="Enter your Address">{{ $shop['address_2'] }}</textarea>
                                    </div>
