...
@section('content')
    <section class="content">
        ...
        @endif
        <form id="user-form" method="POST" action="{{ url('employee/edit-employee') }}" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input readonly type="text" class="form-control" name="ref_number"
                                    ...
                                    <div class="col-lg-6 col-md-6 rounded border">
                                        ...
                                        <div class="form-group">
                                            <input type="file" name="picture_document[]" accept=".png, .jpg, .jpeg"
                                                class="form-control" />
