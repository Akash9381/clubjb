                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            ="phone" value="{{ request()->get('phone') }}" name="phone" required class="form-control"
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" required name="ref_number" value="{{ Auth::user()->customer_id }}" class="form-control" placeholder="Ref mobile number" />
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
