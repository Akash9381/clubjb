        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="{{url('shopkeeper/dashboard')}}" class="toggled waves-effect waves-block"><i
                                class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>


                    <li><a href="{{url('shopkeeper/customer-report')}}" class=" waves-effect waves-block"><i class="zmdi zmdi-eye"></i><span>
                                Customer Report</span></a>
                    </li>

                    <li><a href="{{url('shopkeeper/shopkeeper-reports')}}" class=" waves-effect waves-block"><i class="zmdi zmdi-eye"></i><span>
