            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="{{url('shopkeeper/dashboard')}}"><i class="zmdi zmdi-home"></i></a></li>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    ...
                                    <span class="job_post">******{{ substr($shop['ref_number'], -4) }}</span>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <a href="{{ url('shopkeeper/shop-update/' . $shop['shop_id']) }}"
