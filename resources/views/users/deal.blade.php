...
<body>
                        ...
                        <div class="card user-data-card">
                            <div class="card-body">
                                <div class="single-profile-data d-flex align-items-center justify-content-between">
                                    <div class="title d-flex align-items-center"><span>Buy 1 tub Popcron & Get 2 Cold
                                            drink</span></div>
                                    <div class="data-content text-success">Savings Up to ₹150.0</div>
                                </div>
                                <div class="single-profile-data d-flex align-items-center justify-content-between">
                                    <div class="title d-flex align-items-center"><span>Carnival Cimemas</span></div>
                                    <div class="data-content"><a class="btn btn-primary" href="#">Call Now</a>
                                    </div>
                                </div>
                                <div class="single-profile-data d-flex align-items-center justify-content-between">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><img width="30px" src="img/icons/fav.jpg"></td>
                                                    <td>5.0</td>
    ...
    <div class="footer-nav-area" id="footerNav">
        <div class="suha-footer-nav">
            <div class="data-content text-center"><a class="btn btn-primary call" href="#"> <i
